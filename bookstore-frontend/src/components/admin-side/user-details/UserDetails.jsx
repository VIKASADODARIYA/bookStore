...
const UserDetails = () => {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get('http://192.168.134.227:5002/admin/users');
    ...
    const confirmDeleteUser = async () => {
        try {
            const response = await axios.delete(`http://192.168.134.227:5002/admin/delete-users/${deleteUserId}`);
