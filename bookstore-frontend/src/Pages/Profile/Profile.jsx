...
const Profile = () => {
    ...
    const fetchUserData = async (userId) => {
        try {
            const response = await fetch(`http://192.168.134.227:5002/user/userdetails/${userId}`);
            if (!response.ok) {
    ...
    const deleteUser = async () => {
        try {
            const response = await fetch(`http://192.168.134.227:5002/user/delete-user/${authUser._id}`, {
                method: 'DELETE',
                headers: {
